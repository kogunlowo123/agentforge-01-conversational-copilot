# AgentForge 01 — Conversational & Copilot Assistants

![Category](https://img.shields.io/badge/Category-01-c8420a) ![Cloud](https://img.shields.io/badge/Cloud-AWS%20%7C%20Azure%20%7C%20GCP-0078d4) ![License](https://img.shields.io/badge/License-MIT-16a34a)

## Quick Start
```bash
cp .env.example .env && pip install -r requirements.txt
python -m labs.exercise_01_1_beginner.agent
...
├── labs/exercise_01_*/             # 4 exercises (beginner → stretch)
...
- [Architecture Diagram](https://kogunlowo123.github.io/agentforge-portal/diagrams/01-conversational-copilot.html)
